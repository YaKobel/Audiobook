...
class Movie(models.Model):
    ...
    directors = models.ManyToManyField(Actor, verbose_name="режиссер", related_name="films_director")
    actors = models.ManyToManyField(Actor, verbose_name="актеры", related_name="films_actor")
...
class MovieShots(models.Model):
    """Кадры из фильма"""
    title = models.CharField("Заговолок", max_length=100)
    description = models.TextField("Описание")
    image = models.ImageField("Изображение", upload_to="movie_shots/")
    category = models.ForeignKey(Movie, verbose_name="Фильм", on_delete=models.CASCADE)
